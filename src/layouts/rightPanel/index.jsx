...
import {updateSetting, updateSetting_State} from "@/store/action";
import clip from "@/tools/clipboard";
...
const RightPanel = (props) => {
  ...
  const sidebarLogoChange = (checked) => {
    ...
    updateSetting({key: "sidebarLogo", value: checked});
  };

  const fixedHeaderChange = (checked) => {
    setFixedHeader(checked);
    updateSetting({key: "fixedHeader", value: checked});
  };

  const tagsViewChange = (checked) => {
    setTagsView(checked);
    updateSetting({key: "tagsView", value: checked});
  };
...
export default connect(mapStateToProps, {updateSetting_State, updateSetting})(
  RightPanel
);
